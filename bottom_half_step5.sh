...
cactus jobstore/9 bottom_half_step5.txt bottom_half_step5.hal --root Anc_arctos --realTimeLogging --logInfo --retryCount 10 --maxCores 40 --maxMemory 170Gi --workDir workdir_tmp

hal2fasta bottom_half_step5.hal Anc_arctos > Anc_arctos.fa
